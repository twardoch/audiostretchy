...
Welcome to `audiostretchy` contributor's guide.
...
If you experience bugs or general issues with `audiostretchy`, please have a look
...
You can help improve `audiostretchy` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`audiostretchy` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `audiostretchy`'s files. While this mechanism can
...
```
conda create -n audiostretchy python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/audiostretchy.git
   cd audiostretchy
   ```
...
5. Install [pre-commit]:
   ...
   `audiostretchy` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/audiostretchy
[issue tracker]: https://github.com/<USERNAME>/audiostretchy/issues
